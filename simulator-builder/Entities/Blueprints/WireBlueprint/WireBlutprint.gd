...
static func set_sprite_for_direction(sprite:Sprite, direction:int) -> void:
	sprite.region_rect = get_region_for_direction(direction)

static func get_region_for_direction(direction:int) -> Rect2:
